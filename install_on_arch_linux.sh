sudo pacman -S playerctl vim polybar xorg-xbacklight arandr flameshot feh i3blocks i3status i3 i3-wm lxappearance rofi unclutter cargo papirus-icon-theme imagemagick picom arc-gtk-theme arc-icon-theme gtk-engine-murrine elementary-icon-theme autoconf meson zsh alacritty
