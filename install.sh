...
sudo apt-get install -y unzip curl playerctl vim polybar arandr xbacklight flameshot arc-theme feh i3blocks i3status i3 i3-wm lxappearance python3-pip rofi unclutter cargo compton papirus-icon-theme imagemagick
